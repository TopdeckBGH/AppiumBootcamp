...
public class TutorialPage {
    ...
    public void dragAndDropTVTutorial() { elementHelper.dragAndDropElement(600, 600, 0, 600);}
    ...
    public void typeSearchButtonProduct (String text) {elementHelper.sendKey(searchButtonProduct, text);}
